...
class BaseProject:
    ...
    def __init__(self, host='localhost', openplaxis=False, plaxis_visible=True,
        ...
        if openplaxis:
            ...
            self._s_i, self._g_i = self._new_server(host, 10000,password=password,timeout=10)
            self._s_o, self._g_o = self._new_server(host, 10001,password=password,timeout=10)
